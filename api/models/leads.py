...
class LeadGroup(models.Model):
    ...
    agent_profile = models.ForeignKey(AgentProfile, on_delete=models.CASCADE, related_name="lead_groups")
...
class Lead(models.Model):
    ...
    assigned_agent = models.ForeignKey(AgentProfile, on_delete=models.CASCADE, related_name='leads')
...
class LeadAssignmentHistory(models.Model):
    ...
    previous_agent_profile = models.ForeignKey(Ag, on_delete=models.SET_NULL, null=True, related_name='previous_assignments')
